...
<body>
    ...
    <g:render template="editing_tips" />
        ...
        <div class="form-group">
            ...
            ${contentInstance.location?.city}<br/>
...
<script>
    $(function() {
        ...
        var myLatlng = new google.maps.LatLng(${contentInstance.location?.lat?:24}, ${contentInstance.location?.lon?:120});
        ...
        google.maps.event.addListener(marker, 'dragend', function(event) {
            ...
            var callbackUrl = "${createLink(controller: 'content', action: 'updateLocation', id: contentInstance.id)}";
