	...
	<div style="display: table-row;">
		...
		<div style="display: table-cell; width: 60%; padding-left: 15px;">
			<g:link uri="javascript: showContent('${it.id}');">
				<strong><span class="text-uppercase" style="color: #787878; font-size: 20px; -webkit-font-smoothing: antialiased;">${it.cropTitle}</span></strong>
			</g:link>
			...
			<div style="padding-top: 9px; color: #787878;">
				<p class="text-left" style="-webkit-font-smoothing: antialiased; line-height: 140%;">${it.cropText}</p>
			</div>
		</div>
	</div>
</div>