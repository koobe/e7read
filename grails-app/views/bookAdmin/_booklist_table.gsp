<div>
	...
	<table class="table table-hover">
			<tr>
				...
				<th align="center" class="table-header" style="width: 100px; vertical-align:middle; text-align: center;"><i class="fa fa-calendar"></i>&nbsp;出版日期</th>
			...
			<g:if test="${books}">
				<g:each in="${books}" var="book">
					...
					<tr class="">
						...
						<td valign="middle" style="vertical-align:middle; text-align: center;">
							<g:link controller="bookAdmin" action="book" id="${book.id}">編輯</g:link>
						</td>
					</tr>
				</g:each>
			</g:if>
