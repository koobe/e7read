		...
		<div style="display: table; border-spacing: 5px; width:100%; height:70%;">
			<div style="display: table-row; border: 1px solid red;">
				...
				<div style="display: table-cell; width:65%; height:100%; ">
					<div style="width:100%; height:100%;">
						<div style="width:100%; height:49%; border-radius: 5px; background-position: center; background-repeat: no-repeat; background-size: cover; background-image:url(${content.pictureSegments[0].originalUrl});"></div>
				...
				<div style="display: table-cell; width:35%; height:100%; border-radius: 5px; background-position: center; background-repeat: no-repeat; background-size: cover; background-image:url(${content.pictureSegments[2].originalUrl});"></div>
			</div>
		</div>
